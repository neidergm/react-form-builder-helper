import{c as G,I as H,g as r}from"./FormFieldsComponentsForStory-ca584217.js";import"./jsx-runtime-6278a575.js";import"./index-453e6029.js";import"./index-d765e9f1.js";import"./DynamicFormBuilder-4eabcda7.js";const V={...G,title:"Field tags/Input",component:H,parameters:{controls:{sort:"requiredFirst"}},argTypes:{tag:{control:"inline-radio",options:["input"]}},args:{tag:"input"},tags:["autodocs"]},e={args:r("text")},s={args:r("number")},a={args:r("email")},o={args:r("textarea")},t={args:r("url")},c={args:r("tel")},m={args:r("search")},p={args:r("password")},n={args:r("color")},g={args:r("range")};var i,u,l;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
...
}`,...(U=(R=m.parameters)==null?void 0:R.docs)==null?void 0:U.source}}};var _,q,O;p.parameters={...p.parameters,docs:{...(_=p.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: getSimpleStoryArgs<TC>("password")
}`,...(O=(q=p.parameters)==null?void 0:q.docs)==null?void 0:O.source}}};var j,k,v;n.parameters={...n.parameters,docs:{...(j=n.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: getSimpleStoryArgs<TC>("color")
}`,...(v=(k=n.parameters)==null?void 0:k.docs)==null?void 0:v.source}}};var z,B,D;g.parameters={...g.parameters,docs:{...(z=g.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: getSimpleStoryArgs<TC>("range")
}`,...(D=(B=g.parameters)==null?void 0:B.docs)==null?void 0:D.source}}};const W=["Text","Number","Email","Textarea","Url","Tel","Search","Password","Color","Range"];export{n as Color,a as Email,s as Number,p as Password,g as Range,m as Search,c as Tel,e as Text,o as Textarea,t as Url,W as __namedExportsOrder,V as default};
